# CARD WARS GAME
# REFER: https://en.wikipedia.org/wiki/War_(card_game)
...
class Deck:
    """
    This is a Deck class. This object will create a deck of cards to initiate play.
    You can then use this Deck list of cards to split in half and give to the players.
    It will use SUITE and RANKS to create the deck. It should also have a method for splitting/cutting the 
    decl in half and shuffling the deck.
    """
    def __init__(self):
...
class Player:
    """
    This is the Player class, which takes the name and instance of a Hand class object. The Player can
